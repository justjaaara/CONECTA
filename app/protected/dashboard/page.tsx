  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <DasboardHeader />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
          ...
          <div className="bg-gradient-to-b from-black to-[#c1ff00]/40 border border-gray-700 rounded-2xl p-6 md:row-span-1 text-white shadow-xl">
            ...
            <p className="text-sm text-gray-400 mb-6">Energía consumida hasta ahora</p>
          ...
          <div className="bg-[#c1ff00]/5 border border-gray-700 rounded-2xl p-6 md:col-span-1 text-white shadow-xl">
            ...
            <p className="text-sm text-gray-400 mb-6">Gráficas de consumo de energía</p>
      ...
      <div className="bg-[#c1ff00]/5 border border-gray-700 rounded-2xl p-6 md:row-span-1 text-white shadow-xl">
        <h2 className="text-2xl font-bold mb-6">Consumo de Energía Total</h2>

      {/* Labels */}
      <div className="flex justify-between text-sm text-gray-300 mb-4">
        <div className="flex items-center font-semibold">Microondas <ChevronUp className="ml-1 h-3 w-3" /></div>
        <div className="flex items-center font-semibold">Nevera <ChevronDown className="ml-1 h-3 w-3" /></div>
        <div className="flex items-center font-semibold">Aire AC <ChevronUp className="ml-1 h-3 w-3" /></div>
      </div>
      ...
      <Tabs defaultValue="cocina">
        <TabsList className="flex justify-between gap-1 bg-[#c1ff00]/20 border border-white/10 rounded-full p-1 text-white text-sm">
          ...
          <div className="bg-[#c1ff00]/5 border border-gray-700 rounded-2xl p-6 md:row-span-1 text-white shadow-xl">
            <h2 className="text-xl font-semibold mb-2">Zona con Mayor Consumo de Energía</h2>
          ...
          <div className="bg-[#c1ff00]/5 border border-gray-700 rounded-2xl p-6 md:row-span-1 text-white shadow-xl">
            ...
            <p className="text-sm text-gray-400 mb-4">Tips personalizados para optimizar energía</p>

            <div className="space-y-4">
              <div className="bg-[#c1ff00] text-black p-4 rounded-lg">
                <p className="font-medium">Desconecta electrodomésticos que no uses</p>
              </div>

              <div className="bg-black border border-gray-800 p-4 rounded-lg">
                <p className="font-medium">Aprovecha al máximo la luz natural</p>
          ...
          <div className="bg-[#c1ff00]/5 border border-gray-700 rounded-2xl p-6 md:col-span-2 text-white shadow-xl">
            <h2 className="text-xl font-semibold mb-4">Evolución del costo $</h2>

            <div className="flex items-end justify-around h-32 mb-4">
              <div className="flex flex-col items-center">
                <div className="bg-[#c1ff00]/40 w-10 rounded-full" style={{ height: "80px" }}></div>
                <div className="text-xs text-gray-400 mt-2">Ene</div>
              </div>
              <div className="flex flex-col items-center">
                <div className="bg-[#c1ff00]/60 w-10 rounded-full" style={{ height: "100px" }}></div>
                <div className="text-xs text-gray-400 mt-2">Feb</div>
              </div>
              <div className="flex flex-col items-center">
                <div className="bg-[#c1ff00]/80 w-10 rounded-full" style={{ height: "70px" }}></div>
                <div className="text-xs text-gray-400 mt-2">Mar</div>
              </div>
              <div className="flex flex-col items-center">
                <div className="bg-[#c1ff00] w-10 rounded-full" style={{ height: "120px" }}></div>
            ...
            <div className="bg-black border border-gray-800 p-4 rounded-lg">
              <p>
                Superaste el consumo del mes de <span className="text-[#c1ff00]">Marzo</span>, por lo que para{" "}
